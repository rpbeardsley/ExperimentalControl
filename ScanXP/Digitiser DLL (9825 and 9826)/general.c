...
short _stdcall OutPort( int PortAddress, int PortData )
{
  short Dummy; 
...
short _stdcall InPort( int PortAddress ) 
{
  short PortData; 
...
int _stdcall DoDriverAction( int nACTION ) 
{
	switch(nACTION)
	{
