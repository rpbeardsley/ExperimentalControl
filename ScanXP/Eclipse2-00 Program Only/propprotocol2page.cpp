//***************************************************************************************
//PropProtocol2Page.cpp : implementation file
//
//	Functions: For details on functions in this file see PropProtocol2Page.h
//
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol2Page property page

IMPLEMENT_DYNCREATE(CPropProtocol2Page, CPropertyPage)

CPropProtocol2Page::CPropProtocol2Page() : CPropertyPage(CPropProtocol2Page::IDD)
{
	//{{AFX_DATA_INIT(CPropProtocol2Page)
...
CPropProtocol2Page::~CPropProtocol2Page()
{
}

void CPropProtocol2Page::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropProtocol2Page)
...
BEGIN_MESSAGE_MAP(CPropProtocol2Page, CPropertyPage)
	//{{AFX_MSG_MAP(CPropProtocol2Page)
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol2Page message handlers
void CPropProtocol2Page::UpdateFromInst()
{
	...
	try
	{
		...
		SetDlgItemText(IDC_CAL_PATH, pApp->GetProt1CalPath() );
	}
...
BOOL CPropProtocol2Page::OnInitDialog() 
{
...
void CPropProtocol2Page::OnAdvanced() 
{
	CCompAdvanced adv(this, PROTOCOL);
	adv.DoModal();
}

void CPropProtocol2Page::OnProtcolAdvanced() 
{
	CProtocolAdvanced adv(this, PROTOCOL);
	if(adv.DoModal() == IDOK)SetModified();
}

void CPropProtocol2Page::OnCompression() 
{
	SetModified();	
}

void CPropProtocol2Page::OnAutonoise() 
{
...
void CPropProtocol2Page::OnCalBrowse() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	OpenFile.m_ofn.lpstrTitle=_T("Set a Eclipse Calibration file for Protocol #1");
	...
	if(OpenFile.DoModal()==IDOK)
	{
		...
		pApp->SetProt1CalPath( OpenFile.GetPathName() );
	}
	
}

void CPropProtocol2Page::OnChangeCalPath() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	pApp->SetProt1CalPath( Text );
	SetModified();
}

BOOL CPropProtocol2Page::OnApply() 
{
	TRACE("Apply called from prot #2\n");
	
	return CPropertyPage::OnApply();
}

void CPropProtocol2Page::OnUpdateRecordlength() 
{
	SetModified();
}

void CPropProtocol2Page::OnUpdateTriggerdelay() 
{
	SetModified();
}

void CPropProtocol2Page::OnUpdateOffset() 
{
	SetModified();
}

void CPropProtocol2Page::OnUpdateRecordpreset() 
{
	SetModified();
}

void CPropProtocol2Page::OnSelchangePeriod() 
{
	SetModified();
}
