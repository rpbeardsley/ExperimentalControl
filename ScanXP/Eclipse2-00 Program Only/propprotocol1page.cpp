//***************************************************************************************
//PropProtocol1Page.cpp : implementation file
//
//	Functions: For details on functions in this file see PropProtocol1Page.h
//
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol1Page property page

IMPLEMENT_DYNCREATE(CPropProtocol1Page, CPropertyPage)

CPropProtocol1Page::CPropProtocol1Page() : CPropertyPage(CPropProtocol1Page::IDD)
{
	//{{AFX_DATA_INIT(CPropProtocol1Page)
...
CPropProtocol1Page::~CPropProtocol1Page()
{
}

void CPropProtocol1Page::DoDataExchange(CDataExchange* pDX)
{

	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropProtocol1Page)
...
BEGIN_MESSAGE_MAP(CPropProtocol1Page, CPropertyPage)
	//{{AFX_MSG_MAP(CPropProtocol1Page)
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol1Page message handlers

void CPropProtocol1Page::UpdateFromInst()
{
	...
	try
	{
		...
		SetDlgItemText(IDC_CAL_PATH, pApp->GetProt0CalPath() );
	}
...
BOOL CPropProtocol1Page::OnInitDialog() 
{
...
void CPropProtocol1Page::OnAdvanced() 
{
	CCompAdvanced adv(this, PROTOCOL);
	adv.DoModal();
}

void CPropProtocol1Page::OnProtcolAdvanced() 
{
	CProtocolAdvanced adv(this, PROTOCOL);
	if(adv.DoModal()==IDOK)SetModified();
}

void CPropProtocol1Page::OnCompression() 
{
	
	SetModified();	
}

void CPropProtocol1Page::OnAutonoise() 
{
...
void CPropProtocol1Page::OnCalBrowse() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	OpenFile.m_ofn.lpstrTitle=_T("Set a Eclipse Calibration file for Protocol #0");
	...
	if(OpenFile.DoModal()==IDOK)
	{
		...
		pApp->SetProt0CalPath( OpenFile.GetPathName() );
	}
	
}

void CPropProtocol1Page::OnChangeCalPath() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	pApp->SetProt0CalPath( Text );
	SetModified();
}

BOOL CPropProtocol1Page::OnApply() 
{
	TRACE("Apply called from prot #1\n");
	
	return CPropertyPage::OnApply();
}

void CPropProtocol1Page::OnUpdateRecordlength() 
{
	SetModified();
}

void CPropProtocol1Page::OnUpdateTriggerdelay() 
{
	SetModified();
}

void CPropProtocol1Page::OnUpdateOffset() 
{
	SetModified();	
}

void CPropProtocol1Page::OnUpdateRecordpreset() 
{
	SetModified();
}

void CPropProtocol1Page::OnSelchangePeriod() 
{
	SetModified();	
}
