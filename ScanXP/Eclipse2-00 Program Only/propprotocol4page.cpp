//***************************************************************************************
//PropProtocol4Page.cpp : implementation file
//
//	Functions: For details on functions in this file see PropProtocol4Page.h
//
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol4Page property page

IMPLEMENT_DYNCREATE(CPropProtocol4Page, CPropertyPage)

CPropProtocol4Page::CPropProtocol4Page() : CPropertyPage(CPropProtocol4Page::IDD)
{
	//{{AFX_DATA_INIT(CPropProtocol4Page)
...
CPropProtocol4Page::~CPropProtocol4Page()
{
}

void CPropProtocol4Page::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropProtocol4Page)
...
BEGIN_MESSAGE_MAP(CPropProtocol4Page, CPropertyPage)
	//{{AFX_MSG_MAP(CPropProtocol4Page)
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol4Page message handlers
void CPropProtocol4Page::UpdateFromInst()
{
	...
	try
	{
		...
		SetDlgItemText(IDC_CAL_PATH, pApp->GetProt3CalPath() );
	}
...
BOOL CPropProtocol4Page::OnInitDialog() 
{
...
void CPropProtocol4Page::OnAdvanced() 
{
	CCompAdvanced adv(this, PROTOCOL);
	adv.DoModal();
}

void CPropProtocol4Page::OnProtcolAdvanced() 
{
	CProtocolAdvanced adv(this, PROTOCOL);
	if(adv.DoModal() == IDOK)SetModified();
}

void CPropProtocol4Page::OnCompression() 
{
	SetModified();	
}

void CPropProtocol4Page::OnAutonoise() 
{
...
void CPropProtocol4Page::OnCalBrowse() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	OpenFile.m_ofn.lpstrTitle=_T("Set a Eclipse Calibration file for Protocol #3");
	...
	if(OpenFile.DoModal()==IDOK)
	{
		...
		pApp->SetProt3CalPath( OpenFile.GetPathName() );
	}
	
}

void CPropProtocol4Page::OnChangeCalPath() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	pApp->SetProt3CalPath( Text );
	SetModified();
}


void CPropProtocol4Page::OnUpdateRecordlength() 
{
	SetModified();
}

void CPropProtocol4Page::OnUpdateTriggerdelay() 
{
	SetModified();
}

void CPropProtocol4Page::OnUpdateOffset() 
{
	SetModified();
}

void CPropProtocol4Page::OnUpdateRecordpreset() 
{
	SetModified();
}

void CPropProtocol4Page::OnSelchangePeriod() 
{
	SetModified();
}
