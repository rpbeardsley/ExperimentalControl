//***************************************************************************************
//PropProtocol3Page.cpp : implementation file
//
//	Functions: For details on functions in this file see PropProtocol3Page.h
//
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol3Page property page

IMPLEMENT_DYNCREATE(CPropProtocol3Page, CPropertyPage)

CPropProtocol3Page::CPropProtocol3Page() : CPropertyPage(CPropProtocol3Page::IDD)
{
	//{{AFX_DATA_INIT(CPropProtocol3Page)
...
CPropProtocol3Page::~CPropProtocol3Page()
{
}

void CPropProtocol3Page::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropProtocol3Page)
...
BEGIN_MESSAGE_MAP(CPropProtocol3Page, CPropertyPage)
	//{{AFX_MSG_MAP(CPropProtocol3Page)
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol3Page message handlers
void CPropProtocol3Page::UpdateFromInst()
{
	...
	try
	{
		...
		SetDlgItemText(IDC_CAL_PATH, pApp->GetProt2CalPath() );
	}
...
BOOL CPropProtocol3Page::OnInitDialog() 
{
...
void CPropProtocol3Page::OnAdvanced() 
{
	CCompAdvanced adv(this, PROTOCOL);
	adv.DoModal();
}

void CPropProtocol3Page::OnProtcolAdvanced() 
{
	CProtocolAdvanced adv(this, PROTOCOL);
	if(adv.DoModal() == IDOK)SetModified();
}

void CPropProtocol3Page::OnCompression() 
{
	SetModified();	
}

void CPropProtocol3Page::OnAutonoise() 
{
...
void CPropProtocol3Page::OnCalBrowse() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	OpenFile.m_ofn.lpstrTitle=_T("Set a Eclipse Calibration file for Protocol #2");
	...
	if(OpenFile.DoModal()==IDOK)
	{
		...
		pApp->SetProt2CalPath( OpenFile.GetPathName() );
	}
	
}

void CPropProtocol3Page::OnChangeCalPath() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	pApp->SetProt2CalPath( Text );
	SetModified();
}

void CPropProtocol3Page::OnUpdateRecordlength() 
{
	SetModified();
}

void CPropProtocol3Page::OnUpdateTriggerdelay() 
{
	SetModified();	
}

void CPropProtocol3Page::OnUpdateOffset() 
{
	SetModified();	
}

void CPropProtocol3Page::OnUpdateRecordpreset() 
{
	SetModified();	
}

void CPropProtocol3Page::OnSelchangePeriod() 
{
	SetModified();	
}
