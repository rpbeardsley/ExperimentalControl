//***************************************************************************************
//PropProtocol6Page.cpp : implementation file
//
//	Functions: For details on functions in this file see PropProtocol6Page.h
//
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol6Page property page

IMPLEMENT_DYNCREATE(CPropProtocol6Page, CPropertyPage)

CPropProtocol6Page::CPropProtocol6Page() : CPropertyPage(CPropProtocol6Page::IDD)
{
	//{{AFX_DATA_INIT(CPropProtocol6Page)
...
CPropProtocol6Page::~CPropProtocol6Page()
{
}

void CPropProtocol6Page::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropProtocol6Page)
...
BEGIN_MESSAGE_MAP(CPropProtocol6Page, CPropertyPage)
	//{{AFX_MSG_MAP(CPropProtocol6Page)
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol6Page message handlers

void CPropProtocol6Page::UpdateFromInst()
{
	...
	try
	{
		...
		SetDlgItemText(IDC_CAL_PATH, pApp->GetProt5CalPath() );
	}
...
BOOL CPropProtocol6Page::OnInitDialog() 
{
...
void CPropProtocol6Page::OnAdvanced() 
{
	CCompAdvanced adv(this, PROTOCOL);
	adv.DoModal();
}

void CPropProtocol6Page::OnProtcolAdvanced() 
{
	CProtocolAdvanced adv(this, PROTOCOL);
	if(adv.DoModal() == IDOK)SetModified();
}

void CPropProtocol6Page::OnCompression() 
{
	SetModified();	
}

void CPropProtocol6Page::OnAutonoise() 
{
...
void CPropProtocol6Page::OnCalBrowse() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	OpenFile.m_ofn.lpstrTitle=_T("Set a Eclipse Calibration file for Protocol #5");
	...
	if(OpenFile.DoModal()==IDOK)
	{
		...
		pApp->SetProt5CalPath( OpenFile.GetPathName() );
	}
	
}

void CPropProtocol6Page::OnChangeCalPath() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	pApp->SetProt5CalPath( Text );
	SetModified();
}


void CPropProtocol6Page::OnUpdateRecordlength() 
{
	SetModified();
}

void CPropProtocol6Page::OnUpdateTriggerdelay() 
{
	SetModified();
}

void CPropProtocol6Page::OnUpdateOffset() 
{
	SetModified();
}

void CPropProtocol6Page::OnUpdateRecordpreset() 
{
	SetModified();
}

void CPropProtocol6Page::OnSelchangePeriod() 
{
	SetModified();
}
