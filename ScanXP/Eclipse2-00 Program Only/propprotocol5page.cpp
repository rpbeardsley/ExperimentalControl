//***************************************************************************************
//PropProtocol5Page.cpp : implementation file
//
//	Functions: For details on functions in this file see PropProtocol5Page.h
//
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol5Page property page

IMPLEMENT_DYNCREATE(CPropProtocol5Page, CPropertyPage)

CPropProtocol5Page::CPropProtocol5Page() : CPropertyPage(CPropProtocol5Page::IDD)
{
	//{{AFX_DATA_INIT(CPropProtocol5Page)
...
CPropProtocol5Page::~CPropProtocol5Page()
{
}

void CPropProtocol5Page::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropProtocol5Page)
...
BEGIN_MESSAGE_MAP(CPropProtocol5Page, CPropertyPage)
	//{{AFX_MSG_MAP(CPropProtocol5Page)
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol5Page message handlers
void CPropProtocol5Page::UpdateFromInst()
{
	...
	try
	{
		...
		SetDlgItemText(IDC_CAL_PATH, pApp->GetProt4CalPath() );
	}
...
BOOL CPropProtocol5Page::OnInitDialog() 
{
...
void CPropProtocol5Page::OnAdvanced() 
{
	CCompAdvanced adv(this, PROTOCOL);
	adv.DoModal();
}

void CPropProtocol5Page::OnProtcolAdvanced() 
{
	CProtocolAdvanced adv(this, PROTOCOL);
	if( adv.DoModal() == IDOK)SetModified();
}

void CPropProtocol5Page::OnCompression() 
{

	SetModified();	
}

void CPropProtocol5Page::OnAutonoise() 
{
...
void CPropProtocol5Page::OnCalBrowse() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	OpenFile.m_ofn.lpstrTitle=_T("Set a Eclipse Calibration file for Protocol #4");
	...
	if(OpenFile.DoModal()==IDOK)
	{
		...
		pApp->SetProt4CalPath( OpenFile.GetPathName() );
	}
	
}

void CPropProtocol5Page::OnChangeCalPath() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	pApp->SetProt4CalPath( Text );
	SetModified();
}

void CPropProtocol5Page::OnUpdateRecordlength() 
{
	SetModified();
}

void CPropProtocol5Page::OnUpdateTriggerdelay() 
{
	SetModified();
}

void CPropProtocol5Page::OnUpdateOffset() 
{
	SetModified();
}

void CPropProtocol5Page::OnUpdateRecordpreset() 
{
	SetModified();
}

void CPropProtocol5Page::OnSelchangePeriod() 
{
	SetModified();	
}
