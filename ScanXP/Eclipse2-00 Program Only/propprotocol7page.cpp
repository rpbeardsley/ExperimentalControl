//***************************************************************************************
//PropProtocol7Page.cpp : implementation file
//
//	Functions: For details on functions in this file see PropProtocol7Page.h
//
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol7Page property page

IMPLEMENT_DYNCREATE(CPropProtocol7Page, CPropertyPage)

CPropProtocol7Page::CPropProtocol7Page() : CPropertyPage(CPropProtocol7Page::IDD)
{
	//{{AFX_DATA_INIT(CPropProtocol7Page)
...
CPropProtocol7Page::~CPropProtocol7Page()
{
}

void CPropProtocol7Page::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPropProtocol7Page)
...
BEGIN_MESSAGE_MAP(CPropProtocol7Page, CPropertyPage)
	//{{AFX_MSG_MAP(CPropProtocol7Page)
...
/////////////////////////////////////////////////////////////////////////////
// CPropProtocol7Page message handlers
void CPropProtocol7Page::UpdateFromInst()
{
	...
	try
	{
		...
		SetDlgItemText(IDC_CAL_PATH, pApp->GetProt6CalPath() );
	}
...
BOOL CPropProtocol7Page::OnInitDialog() 
{
...
void CPropProtocol7Page::OnAdvanced() 
{
	CCompAdvanced adv(this, PROTOCOL);
	adv.DoModal();
}

void CPropProtocol7Page::OnProtcolAdvanced() 
{
	CProtocolAdvanced adv(this, PROTOCOL);
	if(adv.DoModal()==IDOK)SetModified();
}

void CPropProtocol7Page::OnCompression() 
{
	SetModified();	
}

void CPropProtocol7Page::OnAutonoise() 
{
...
void CPropProtocol7Page::OnCalBrowse() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	OpenFile.m_ofn.lpstrTitle=_T("Set a Eclipse Calibration file for Protocol #6");
	...
	if(OpenFile.DoModal()==IDOK)
	{
		...
		pApp->SetProt6CalPath( OpenFile.GetPathName() );
	}
	
}

void CPropProtocol7Page::OnChangeCalPath() 
{
	CEclipseApp* pApp = (CEclipseApp*)AfxGetApp();
	ASSERT(pApp);
	...
	pApp->SetProt6CalPath( Text );
	SetModified();
}

void CPropProtocol7Page::OnUpdateRecordlength() 
{
	SetModified();
}

void CPropProtocol7Page::OnUpdateTriggerdelay() 
{
	SetModified();
}

void CPropProtocol7Page::OnUpdateOffset() 
{
	SetModified();
}

void CPropProtocol7Page::OnUpdateRecordpreset() 
{
	SetModified();
}

void CPropProtocol7Page::OnSelchangePeriod() 
{
	SetModified();
}
